...
const Login = () => {
    ...
    const baseURL = process.env.NODE_ENV === 'production'
        ? 'https://backend-admin.jjm-manufacturing.com/api/adminusers' // Corrected route
        : 'http://localhost:7690/api/adminusers'; // Corrected route
    ...
    const handleLogin = async (event) => {
        ...
        try {
            ...
            if (role === 'staff' || role === 'admin' || role === 'superadmin') {
                window.location.href = '/home';  // Redirect to home for staff or admin or superadmin //ADDED superadmin role
            } else {
                // Unauthorized role
