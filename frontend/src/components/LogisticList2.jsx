...
const HrList1 = () => {
  ...
  useEffect(() => {
    axios.get(`${baseURL}/get`, {
      params: { page: currentPage, limit: 10, department: 'logistic 2' }
    })
      .then(response => {
  ...
  const exportToExcel = () => {
    ...
    const fetchAllUsers = async () => {
      try {
        ...
        XLSX.writeFile(wb, 'users_Logistic2_backup.xlsx'); // Save the file
      } catch (error) {
...
className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded shadow"
        ...
        <h1 className="text-2xl font-bold mb-4 text-black">Logistic2 Department</h1>
