   ...
   useEffect(() => {
     ...
     const handleUpdate = (user) => {
         ...
         setEditFormData({  // Initialize form data with the user's current values
           ...
           role: user.role,
            LogisticLevel: user.LogisticLevel,
         });
         setIsModalOpen(true);
     };
      ...
      <p>Age: {user.age}</p>
       <p>Condition: {user.condition}</p>
        <p>Verified: {user.verified}</p>
                           <p>Role: {user.role}</p>
                        <p>Logistic Level: {user.LogisticLevel}</p>
                       </div>
                   )}
                       ...
                       <div className="mb-4">
                         ...
                         <div className="mb-4">
                             ...
                             />
                                ...
                                <div className="mb-4">
                     <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="editLogisticLevel">Logistic Level</label>
                     <select className='text-black bg-white border-black border ' name='editLogisticLevel' onChange = {handleEditFormChange}   value={editFormData.LogisticLevel || ''} >
                         ...
                         <tr className="bg-gray-300 text-gray-600 uppercase text-sm leading-normal">
                             ...
                             <th className="py-3 px-6 text-left border">Email</th>
                              ...
                              <th className="py-3 px-6 text-left border">role</th>
                               <th className="py-3 px-6 text-left border">LogisticLevel</th>
                         ...
                         {isLoading ? (
                             ...
                             Array(usersPerPage).fill(0).map((_, index) => (
                                 <tr key={index}>
                                     ...
                                     <td className="py-3 px-6 text-left border-b border-gray-200"><Skeleton width={80} /></td> {/* Skeleton for LogisticLevel */}
