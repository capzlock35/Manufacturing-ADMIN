...
const Logistic1 = () => {
  ...
  useEffect(() => {
    axios.get(`${baseURL}/get`, {
      params: { page: currentPage, limit: 10, department: 'logistic 1' }
    })
      .then(response => {
      ...
      try {
        ...
        for (let page = 1; page <= totalPages; page++) {
          const response = await axios.get(`${baseURL}/get`, {
            params: { page: page, limit: 10, department: 'logistic 1' }
          });
        ...
        XLSX.writeFile(wb, 'users_Logistic1_backup.xlsx'); // Save the file
      } catch (error) {
...
className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded shadow"
        ...
        <h1 className="text-2xl font-bold mb-4 text-black">Logistic1 Department</h1>
      ...
      <div className="mb-4 flex gap-2">
          <Link to="/home/LogisticList1">
            <button
              className={`px-4 py-2 rounded ${
                location.pathname === '/home/LogisticList1'
          ...
          <Link to="/home/LogisticList2">
            <button
              className={`px-4 py-2 rounded ${
                location.pathname === '/home/LogisticList2'
                  ? 'bg-blue-600 text-white font-bold'
                  : 'bg-gray-300 text-black'
              }`}
            >
