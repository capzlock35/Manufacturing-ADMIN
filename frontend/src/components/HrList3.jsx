...
const HrList3 = () => {
  ...
  useEffect(() => {
    axios.get(`${baseURL}/get`, {
      params: { page: currentPage, limit: 10, department: 'hr 3' }
    })
      .then(response => {
      ...
      try {
        ...
        for (let page = 1; page <= totalPages; page++) {
          const response = await axios.get(`${baseURL}/get`, {
            params: { page: page, limit: 10, department: 'hr 3' }
          });
        ...
        XLSX.writeFile(wb, 'users_Hr3_backup.xlsx'); // Save the file
      } catch (error) {
...
className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded shadow"
        ...
        <h1 className="text-2xl font-bold mb-4 text-black">HR3 Department</h1>
